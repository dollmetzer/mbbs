...
<a href="<?php echo $this->buildURL('bbs/mail/out'); ?>" class="btn btn-default btn-xs disabled"><span class="glyphicon glyphicon-log-out"></span> <?php $this->lang('link_outbox'); ?></a></p>
